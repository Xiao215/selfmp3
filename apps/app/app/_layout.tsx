...
function Shell(): ReactNode {
  ...
  useEffect(() => {
    ...
    // The `/spike-*` routes are throwaway scaffolding for the spike in
    // docs/UNIVERSAL.md and go with it; they have no server and no session, so
    // being sent to sign-in would unmount the very thing under test.
    const ownItsRoute =
      pathname === '/onboarding' ||
      pathname === '/sign-in' ||
