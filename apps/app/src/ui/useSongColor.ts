 ...
 * is usually just arithmetic. A song from a server too old to send it, or one
 * it has not read yet, is read here where the platform can (a canvas, in a
 * browser). Until then, and for a cover with no colour in it, the accent
