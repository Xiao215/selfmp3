...
export default defineConfig({
  testDir: '.',
  // A spike answers a yes/no question, so a retry would only hide a flake that
  ...
  use: {
    launchOptions: {
      ...
      // The engine spike calls play() without a click. Without these the
      // browser blocks it and the spike measures Chrome's autoplay policy
